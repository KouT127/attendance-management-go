...
var (
	userAllColumns            = []string{"id", "email", "name", "image_url", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "email", "name", "image_url", "created_at", "updated_at"}
...
func (o *User) Attendances(mods ...qm.QueryMod) attendanceQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`attendances`.`user_id`=?", o.ID),
	)

	query := Attendances(queryMods...)
	queries.SetFrom(query.Query, "`attendances`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`attendances`.*"})
	}
...
func (userL) LoadAttendances(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`attendances`), qm.WhereIn(`attendances.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddAttendancesG(ctx context.Context, insert bool, related ...*Attendance) error {
	return o.AddAttendances(ctx, boil.GetContextDB(), insert, related...)
}

// AddAttendancesP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Attendances.
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddAttendancesP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Attendance) {
	if err := o.AddAttendances(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddAttendancesGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Attendances.
// Sets related.R.User appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddAttendancesGP(ctx context.Context, insert bool, related ...*Attendance) {
	if err := o.AddAttendances(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Appends related to o.R.Attendances.
// Sets related.R.User appropriately.
func (o *User) AddAttendances(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Attendance) error {
	var err error
...
// Sets o.R.User's Attendances accordingly.
// Replaces o.R.Attendances with related.
// Sets related.R.User's Attendances accordingly.
// Uses the global database handle.
func (o *User) SetAttendancesG(ctx context.Context, insert bool, related ...*Attendance) error {
	return o.SetAttendances(ctx, boil.GetContextDB(), insert, related...)
}

// SetAttendancesP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Attendances accordingly.
// Replaces o.R.Attendances with related.
// Sets related.R.User's Attendances accordingly.
// Panics on error.
func (o *User) SetAttendancesP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Attendance) {
	if err := o.SetAttendances(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAttendancesGP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Attendances accordingly.
// Replaces o.R.Attendances with related.
// Sets related.R.User's Attendances accordingly.
// Uses the global database handle and panics on error.
func (o *User) SetAttendancesGP(ctx context.Context, insert bool, related ...*Attendance) {
	if err := o.SetAttendances(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Replaces o.R.Attendances with related.
// Sets related.R.User's Attendances accordingly.
func (o *User) SetAttendances(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Attendance) error {
	query := "update `attendances` set `user_id` = null where `user_id` = ?"
	...
	return o.AddAttendances(ctx, exec, insert, related...)
}
...
// Sets related.R.User.
// Uses the global database handle.
func (o *User) RemoveAttendancesG(ctx context.Context, related ...*Attendance) error {
	return o.RemoveAttendances(ctx, boil.GetContextDB(), related...)
}

// RemoveAttendancesP relationships from objects passed in.
// Removes related items from R.Attendances (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Panics on error.
func (o *User) RemoveAttendancesP(ctx context.Context, exec boil.ContextExecutor, related ...*Attendance) {
	if err := o.RemoveAttendances(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveAttendancesGP relationships from objects passed in.
// Removes related items from R.Attendances (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Uses the global database handle and panics on error.
func (o *User) RemoveAttendancesGP(ctx context.Context, related ...*Attendance) {
	if err := o.RemoveAttendances(ctx, boil.GetContextDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Removes related items from R.Attendances (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemoveAttendances(ctx context.Context, exec boil.ContextExecutor, related ...*Attendance) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.UserID, nil)
		if rel.R != nil {
